...
public class ManitoMemberController {
    ...
    @PostMapping()
    public ResponseEntity<ManitoMemberResponse<Long>> inviteManitoMember(@RequestBody ManitoInviteForm form) {
    ...
    public ResponseEntity<ManitoMemberResponse<?>> updateInviteStatus(@RequestBody ManitoMemberStatusForm form) {
    ...
    public ResponseEntity<ManitoMemberResponse<?>> updateGiftInfo(@RequestBody GiftInfoForm form) {
